...
import de.welt.widgetadapter.SimpleDiffCallback
import de.welt.widgetadapter.Widget
import de.welt.widgetadapter.WidgetAdapter
import de.welt.widgetadapter.WidgetViewHolder
import java.util.*


class CustomWidgetAdapter(layoutInflater: LayoutInflater): WidgetAdapter(layoutInflater) {
